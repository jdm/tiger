<template>
	<Pane>
		<div class="w-full pl-4 p-2 pb-0 flex flex-row items-center space-x-2">
			<Button v-if="app.currentDocument?.timelineIsPlaying" @click="pause" icon="PauseIcon" />
			<Button v-if="!app.currentDocument?.timelineIsPlaying" @click="play" icon="PlayIcon" />
