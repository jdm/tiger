	...
	<div ref="titleBarElement" data-tauri-drag-region @dblclick="handleDoubleClick"
		...
		<div class="flex gap-4">
			...
			<div class="flex-1 flex items-stretch">
				<button @click="appWindow.minimize" tabindex="-1" class="w-12 py-2 px-4 hover:bg-plastic-500">
					<div class="w-2.5 h-0 mx-auto border-t border-zinc-400" />
				</button>
				<button v-if="isMaximized" @click="appWindow.unmaximize" tabindex="-1"
					class="w-12 p-2 px-4 hover:bg-plastic-500">
				...
				<button v-if="!isMaximized" @click="appWindow.maximize" tabindex="-1"
