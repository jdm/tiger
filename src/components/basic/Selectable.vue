<template>
	<div @mouseover="onMouseOver" @mouseout="onMouseOut" class="px-2 py-1 flex items-center gap-4 cursor-pointer"
		...
		<div v-if="actions && actions.length > 0" class="flex gap-1">
