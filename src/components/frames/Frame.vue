...
import { beginDragAndDropFrame, endDragAndDropFrame, revealInExplorer, selectFrame, deleteSelectedFrames, deleteFrame } from "@/backend/api"
import { Frame as FrameDTO } from "@/backend/dto"
